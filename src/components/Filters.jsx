import { RARITIES, CATEGORIES } from '../data/mockSkins'

export default function Filters({ search, setSearch, rarity, setRarity, category, setCategory, sortBy, setSortBy, resetFilters, totalCount }) {
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex items-center justify-between">
        <span className="text-xs text-gray-600">{totalCount} skin{totalCount !== 1 ? 's' : ''} encontrada{totalCount !== 1 ? 's' : ''}</span>
        {hasFilters && (
          <button
