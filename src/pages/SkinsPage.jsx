...
export default function SkinsPage() {
    const { skins, loading, error, ...filterProps } = useSkins();
        ...
        <div className="max-w-7xl mx-auto px-4 py-8 space-y-6">
            <div className="space-y-1">
                ...
                <p className="text-gray-500 text-sm">
                    Explore, filtre e avalie as skins do Counter-Strike 2.
                </p>
            </div>
            ...
            {error ? (
                <div className="text-center py-20 space-y-2">
                    ...
                    <p className="text-gray-400 font-medium">Erro ao carregar skins</p>
                    <p className="text-gray-600 text-sm">{error}</p>
                </div>
            ) : loading ? (
                <div className="space-y-3">
                    <p className="text-gray-600 text-xs animate-pulse">
                        Carregando todas as skins do CS2...
                    </p>
